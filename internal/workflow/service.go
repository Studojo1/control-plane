...
func (s *Service) SubmitJob(ctx context.Context, req *SubmitJobRequest) (*SubmitJobResponse, error) {
	...
	if req.Type != "assignment-gen" && req.Type != "outline-gen" && req.Type != "outline-edit" && req.Type != "resume-gen" && req.Type != "resume-optimize" && req.Type != "resume-preview" && req.Type != "humanizer" {
		return nil, ErrValidation
	}
